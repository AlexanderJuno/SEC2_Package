...
function gui_designer:create(width, height)
  ...
  -- Fills a rectangle with a blank wood plank background image.
  function widget:make_wood_tiled_background(x, y, w, h)
    x = x or 0
    y = y or 0
    w = w or width
    h = h or height
  ...
  -- Makes a frame of the specified size with a wooden border.
	-- Le cadre est celui de droit dans gui.png
  ...
  -- Makes a frame of the specified size with a blank wood border.
	-- Le cadre est celui du bas à gauche dans gui.png
  function widget:make_wood_frame(x, y, width, height)
    draw_frame_8_8(0, 24, canvas, x, y, width, height)
  end

  -- Makes a frame of the specified size with 4 pins wood border.
	-- Le cadre est celui du bas au centre dans gui.png
  function widget:make_4_pins_frame(x, y, width, height)
    draw_frame_8_8(24, 24, canvas, x, y, width, height)
  end

  -- Makes a frame of the specified size with 2 pins wood border.
	-- Le cadre est celui du bas à droite dans gui.png
  function widget:make_2_pins_frame(x, y, width, height)
