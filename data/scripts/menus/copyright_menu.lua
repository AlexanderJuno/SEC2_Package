...
local made_for_school_line1
local made_for_school_line2
local menu_items
...
function copyright_menu:on_started()
  ...
  -- GPLv3 logo
  gpl_logo = sol.surface.create("menus/title_screen/gplv3_logo.png")
 ...
 menu_font, menu_font_size = language_manager:get_menu_font()
  ...
  solarus_license_line1 = sol.text_surface.create{
    ...
    font = menu_font,
		fnot_size = menu_font_size,
    text_key = "menu.solarus_license.line1",
  }
  solarus_license_line2 = sol.text_surface.create{
    ...
    text_key = "menu.solarus_license.line2",
  }
  made_for_school_line1 = sol.text_surface.create{
    horizontal_alignment = "center",
    vertical_alignment = "middle",
    font = menu_font,
		font_size = menu_font_size,
    text_key = "menu.made_for_school.line1",
  }
  made_for_school_line2 = sol.text_surface.create{
    horizontal_alignment = "center",
    vertical_alignment = "middle",
    font = menu_font,
		font_size = menu_font_size,
    text_key = "menu.made_for_school.line2",
  }
  ...
  menu_items = {
    ...
    gpl_logo,
    made_for_school_line1,
    made_for_school_line2,
  }
  ...
  sol.timer.start(copyright_menu,4500, function()
    can_skip_menu = true
...
function copyright_menu:on_draw(screen)
  ...
  made_for_school_line1:draw(screen, screen_center_x, item_y)
  item_y = item_y + menu_font_size + line_spacing
  made_for_school_line2:draw(screen, screen_center_x, item_y)
  item_y = item_y + menu_font_size + line_spacing
end
