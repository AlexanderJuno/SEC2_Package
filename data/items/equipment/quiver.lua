...
function item:on_created()
  item:set_savegame_variable("possession_quiver", variant)
...
function item:on_obtaining(variant, savegame_variable)
  ...
  game:get_item("equipment/quiver"):set_variant(variant)
...
function item:on_variant_changed(variant)
  ...
  if variant == 0 then
	...
	--print("max arrows = ",game:get_item("quiver"):get_max_amount())
end